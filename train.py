...
message = tk.Label(window, text="VESP'S ATTENDANCE SYSTEM",width=70  ,height=3  ,fg="black"  ,bg="#F5E5FC" ,font=('times', 30, ' bold ') ) 
...
clearButton = tk.Button(window, text="Clear", command=clear  ,fg="black"  ,bg="#96E1F2"  ,width=15  ,height=2 ,activebackground = "#96E1F2" ,font=('times', 15, ' bold '))
clearButton.place(x=834, y=400)
clearButton2 = tk.Button(window, text="Clear", command=clear2  ,fg="black"  ,bg="#96E1F2"  ,width=15  ,height=2, activebackground = "#96E1F2" ,font=('times', 15, ' bold '))
...
quitWindow = tk.Button(window, text="Quit", command=  window.destroy ,fg="black"  ,bg="#96E1F2"  ,width=15  ,height=2, activebackground = "#96E1F2" ,font=('times', 15, ' bold '))
quitWindow.place(x=1050, y=600)

scheduleButton = tk.Button(window, text="Start Scheduling", command=clear  ,fg="black"  ,bg="#96E1F2"  ,width=15  ,height=2 ,activebackground = "#96E1F2" ,font=('times', 15, ' bold '))
scheduleButton.place(x=834, y=200)
scheduleButton2 = tk.Button(window, text="Stop Scheduling", command=clear2  ,fg="black"  ,bg="#96E1F2"  ,width=15  ,height=2, activebackground = "#96E1F2" ,font=('times', 15, ' bold '))
