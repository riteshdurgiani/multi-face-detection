...
final_attendance = tk.Button(window, text="Final Attendance", command=quitSchedule ,fg="black"  ,bg="#96E1F2"  ,width=15  ,height=2, activebackground = "#96E1F2" ,font=('times', 15, ' bold '))
